---
name: lisa
description: Use when the user asks about specs, spec-driven development, lisa commands, or wants to implement/verify against behavioral specs in .specs/. Triggers on mentions of "lisa", "spec", "spec-driven", "behavioral spec", or work involving .specs/ directory.
---
